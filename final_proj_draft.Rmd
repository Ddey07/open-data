...
ggplot(data = avg_pass_allowed, aes(x=reorder(def.team,-avg),y=avg)) + 
  geom_bar(stat='identity') + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(x = "Team", y = "Average Number of Passes ()", 
       title = "Passes per by Team")
